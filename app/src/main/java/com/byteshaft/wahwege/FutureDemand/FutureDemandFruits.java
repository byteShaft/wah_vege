...
public class FutureDemandFruits extends Fragment implements HttpRequest.OnErrorListener,
        HttpRequest.OnReadyStateChangeListener {

    private static TextView mCartCount;
    private View mBaseView;
    private ListView mfruitsListView;
    ...
    public static void updateFutureFruitOrder() {
        if (mCartCount != null) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ((AppCompatActivity) getActivity()).getSupportActionBar()
                .setTitle("Demand Fruits");
        setHasOptionsMenu(true);
        mfruitsListView = mBaseView.findViewById(R.id.fruits_list_view);
        ...
        mfruitsListView.setAdapter(futureDemandVegetableFruitsAdapter);
        getFruitsList();
        return mBaseView;
    }
    ...
    private void getFruitsList() {
        ...
        request.open("GET", String.format("%sfuture/fruits/", AppGlobals.BASE_URL));
        request.send();
        Helpers.showProgressDialog(getActivity(), getString(R.string.fruits_list));
    }
