...
public class Fruits extends Fragment implements HttpRequest.OnErrorListener,
    ...
    private ArrayList<VegetablesFruits> mfruitsArrayList;
    ...
    public void getFruitsList() {
        ...
        request.open("GET", String.format("%sfruits/", AppGlobals.BASE_URL));
        request.send();
